    ...
    <div class="page-banner">
      <div class="container banner-inner">
        <div class="banner-text">
          ...
          <p class="banner-desc">开黑组队 · 攻略分享 · 一起热血开战</p>
        </div>
      ...
      <div class="forum-layout">
        ...
        <aside class="category-side">
            ...
            <ul class="category-list">
              ...
              >
                <el-icon class="cat-icon">
                  <component :is="cat.icon || 'TrophyBase'" />
                </el-icon>
          ...
          <div class="side-card side-tip">
            <el-icon class="tip-icon"><Flag /></el-icon>
            <p>快乐游戏，理性竞技</p>
            <p class="tip-sub">分享精彩瞬间与攻略心得</p>
          </div>
        </aside>
...
import {
  Aim, Plus, Trophy, TrophyBase, Grid, Search, Folder, Flag
...
/* 游戏版排序按钮橙红点缀 */
:deep(.sort-group .el-radio-button__inner) {
  transition: all 0.25s;
}

:deep(.sort-group .el-radio-button__original-radio:checked + .el-radio-button__inner) {
  background: linear-gradient(135deg, #f97316, #ef4444);
  border-color: #ef4444;
